...
// Malaysia Flag Component
const MalaysiaFlag = ({ className = "h-4 w-6" }: { className?: string }) => (
  <svg viewBox="0 0 56 28" className={className} aria-label="Malaysian Flag">
    <rect width="56" height="28" fill="#CC0001" />
    <rect width="56" height="2" y="2" fill="#FFF" />
    <rect width="56" height="2" y="6" fill="#FFF" />
    <rect width="56" height="2" y="10" fill="#FFF" />
    <rect width="56" height="2" y="14" fill="#FFF" />
    <rect width="56" height="2" y="18" fill="#FFF" />
    <rect width="56" height="2" y="22" fill="#FFF" />
    <rect width="56" height="2" y="26" fill="#FFF" />
    <rect width="28" height="16" fill="#010066" />
    <circle cx="12" cy="8" r="5" fill="#FFCC00" />
    <circle cx="13.5" cy="8" r="4" fill="#010066" />
    <path d="M18 5 L19.5 8 L18 11 L21 9.5 L24 11 L22.5 8 L24 5 L21 6.5 Z" fill="#FFCC00" />
  </svg>
)
  ...
  <div className="relative mx-auto w-[280px] md:w-[320px]">
    ...
    <div className="relative rounded-[3rem] border-[12px] border-gray-900 bg-gray-900 p-1 shadow-2xl dark:border-gray-700">
      ...
      <div className="relative overflow-hidden rounded-[2.25rem] bg-gradient-to-b from-emerald-50 to-white dark:from-emerald-950 dark:to-gray-900">
        {/* Status Bar */}
        <div className="flex items-center justify-between px-6 py-2 text-[10px] text-gray-600 dark:text-gray-400">
          <span>9:41</span>
        ...
        <div className="space-y-3 p-4 pt-2">
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <MalaysiaFlag className="h-3 w-4" />
              </div>
              <p className="text-[10px] text-gray-500">Year of Assessment 2025</p>
            </div>
          </div>
          
          <p className="text-xs text-gray-700 dark:text-gray-300">Hi, <span className="font-semibold">Dandy</span></p>
          ...
          <div className="rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 p-3 text-white shadow-lg">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-[10px] opacity-90">Tax Filing Deadline</p>
          ...
          <div className="rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600 p-3 text-white shadow-lg">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-[10px] opacity-90">Total Relief Claimed</p>
                <p className="text-xl font-bold">RM 14,850</p>
                <p className="text-[9px] opacity-75">of RM 42,000 maximum</p>
              </div>
              {/* Mini Progress Ring */}
              <div className="relative h-14 w-14">
                ...
                <span className="absolute inset-0 flex items-center justify-center text-[10px] font-bold">35%</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <p className="text-[10px] font-semibold text-gray-700 dark:text-gray-300">Your Reliefs</p>
            {[
    ...
    {/* Floating Elements */}
    <div className="absolute -left-8 top-20 animate-bounce rounded-xl bg-white p-2 shadow-lg dark:bg-gray-800" style={{ animationDelay: "0.5s", animationDuration: "3s" }}>
      <Receipt className="h-6 w-6 text-emerald-600" />
    </div>
    <div className="absolute -right-6 top-32 animate-bounce rounded-xl bg-white p-2 shadow-lg dark:bg-gray-800" style={{ animationDelay: "1s", animationDuration: "2.5s" }}>
      <TrendingUp className="h-6 w-6 text-blue-600" />
    </div>
    <div className="absolute -left-4 bottom-32 animate-bounce rounded-xl bg-white p-2 shadow-lg dark:bg-gray-800" style={{ animationDelay: "1.5s", animationDuration: "3.5s" }}>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50/50 via-white to-white dark:from-emerald-950/20 dark:via-gray-900 dark:to-gray-900">
      {/* Navbar */}
        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <Link href="/" className="flex items-center gap-2">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-600">
              <MalaysiaFlag className="h-5 w-7" />
            </div>
          ...
          <div className="hidden items-center gap-3 md:flex">
            ...
            <Link href="/dashboard">
              <Button className="gap-2 bg-white text-foreground shadow-md hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700">
                <GoogleLogo />
                Sign in with Google
              </Button>
            </Link>
              ...
              <SheetContent side="right" className="w-[280px]">
                <nav className="mt-8 flex flex-col gap-4">
                  ...
                  <Link href="/dashboard" className="mt-4">
                    <Button className="w-full gap-2 bg-white text-foreground shadow-md hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700">
                      <GoogleLogo />
                      Sign in with Google
                    </Button>
                  </Link>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          <div className="absolute right-0 top-0 h-[500px] w-[500px] rounded-full bg-emerald-200/30 blur-3xl dark:bg-emerald-900/20" />
          <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-red-200/20 blur-3xl dark:bg-red-900/10" />
        </div>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="mb-8 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
                <Link href="/dashboard">
                  <Button size="lg" className="gap-2 bg-white px-6 text-foreground shadow-lg hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700">
                    <GoogleLogo />
                    Sign in with Google
                  </Button>
                </Link>
